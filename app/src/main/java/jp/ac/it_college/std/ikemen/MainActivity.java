package jp.ac.it_college.std.ikemen;
...
import jp.ac.it_college.std.ikemen.coupon.CouponUploadFragment;
import jp.ac.it_college.std.ikemen.drawer.DrawerItemClickListener;
import jp.ac.it_college.std.ikemen.drawer.DrawerToggle;
