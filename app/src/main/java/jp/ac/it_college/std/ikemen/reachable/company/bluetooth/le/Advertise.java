package jp.ac.it_college.std.ikemen.reachable.company.bluetooth.le;
...
public class Advertise extends AdvertiseCallback {
    ...
    public void startAdvertise(Context context) {
        ...
        bleServer.setBluetoothGattServer(bluetoothGattServer);
    ...
    public BluetoothGattServer getGattServer(Context context, BluetoothManager manager) {
        if (bluetoothGattServer == null) {
            bluetoothGattServer = manager.openGattServer(context, bleServer);
        }
