package jp.ac.it_college.std.ikemen.coupon;
...
import jp.ac.it_college.std.ikemen.R;
import jp.ac.it_college.std.ikemen.aws.AwsManager;
import jp.ac.it_college.std.ikemen.aws.S3UploadManager;
import jp.ac.it_college.std.ikemen.dialog.ChoiceDialog;
import jp.ac.it_college.std.ikemen.dialog.MultipleCategoryChoiceDialog;
import jp.ac.it_college.std.ikemen.info.CouponInfo;
import jp.ac.it_college.std.ikemen.json.JsonManager;
import jp.ac.it_college.std.ikemen.util.FileUtil;
